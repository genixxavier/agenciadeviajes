...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-07-2020 a las 19:51:55
...
(1, 'gg', 'sadf@dd.com', 'mensaje'),
(2, 'gg', 'sadf@dd.com', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.'),
(3, 'dasdfgfg', 'ggggg@ddd.com', 'ooasolasassdsd'),
(4, 'sadsad', 'sadf@dd.com', 'mensajeasdasdadadad'),
(5, 'Genix', 'sadf@dd.com', 'mensajeasdsadadasdad');
...
CREATE TABLE `viajes` (
  ...
  `disponibles` varchar(3) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
